...
class cracker():
	...
	def info(self):
		print("\nCRACKER")
		print("    Algorithm:         %s" % self.algo)
		print("    Method:            %s" % self.method)
		if not self.rainbow == {}:
			print("    Rainbow loaded:    %s" % self.rainbow_file)
			print("        Algorithm:     %s" % self.rainbow_algo)
			print("        Size:          %d" % len(self.rainbow))
